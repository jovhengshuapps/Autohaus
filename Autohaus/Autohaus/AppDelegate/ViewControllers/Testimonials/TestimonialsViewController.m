...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.labelMessage.text = [item objectForKey:@"message"];
    ...
    CGRect frame = cell.labelMessage.frame;
    
    frame.size = [message sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:cell.labelMessage.textColor,NSForegroundColorAttributeName,cell.labelMessage.font,NSFontAttributeName, nil]];
    
    cell.labelMessage.frame = frame;
    
    cell.viewTestimonialBox.frame = CGRectMake(cell.viewTestimonialBox.frame.origin.x, cell.viewTestimonialBox.frame.origin.y, cell.viewTestimonialBox.frame.size.width, cell.frame.size.height + frame.size.height);
